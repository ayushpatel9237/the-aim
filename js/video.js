...
window.AscentraVideo = (function(){
  ...
  function embedHTML(url){
    ...
    return '<a href="'+url+'" target="_blank" rel="noopener" ' +
           'style="display:flex;width:100%;height:100%;align-items:center;justify-content:center;background:#000;color:#e7c98a;font-family:monospace;letter-spacing:.1em">▶ Watch video</a>';
  }
