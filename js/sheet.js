...
(function(){
  ...
  css.textContent = [
    ...
    '.sh-hero{padding:.4rem;cursor:zoom-in;}',
    '.sh-hero .ph{width:100%;background:rgba(255,255,255,.92);border-radius:10px;overflow:hidden;',
      'display:flex;align-items:center;justify-content:center;}',
    '.sh-hero img{width:100%;height:auto;max-height:56vh;object-fit:contain;display:block;}',
    ...
    '@media (max-width:640px){',
      '.sh{width:94vw;max-height:88vh;padding:.3rem;gap:.5rem;}',
      '.sh-hero img{max-height:38vh;}',
      '.sh-t{width:46px;height:46px;}',
      '.sh-info{padding:.85rem .9rem;}',
      '.sh-name{font-size:1.12rem;}',
      '.sh-price{font-size:1.2rem;}',
